...
class GetNotificationApiRequest
    implements GetNotificationsRequestInterface, ApiRequestInterface {
  List<String>? ids;
  int? limit;
  String? after;

  GetNotificationApiRequest({this.ids, this.limit, this.after});
