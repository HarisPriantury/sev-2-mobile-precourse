...
class CreateMilestoneUseCase extends UseCase<BaseApiResponse, CreateMilestoneRequestInterface> {
  ...
  Future<Stream<BaseApiResponse?>> buildUseCaseStream(
      CreateMilestoneRequestInterface? params,
      ) async {
    final StreamController<BaseApiResponse> _controller = StreamController();
    try {
      BaseApiResponse result = await _repository.createMilestone(params!);
